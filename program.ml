...
let forl func condition reversecondition endvalue ls =
	let rec recursion ls i =
		if i <= endvalue 
			then (
				if (if reversecondition then (not (condition ls i)) else (condition ls i))
					then recursion (setNElement ls i (func ls i)) (i+1)
